...
public class Goods {
    ...
    private String subTitle;// 卖点  **tb_spu数据表里面的**
    private Date createTime;// 创建时间 ---》 tb_spu 


    private Long brandId;// 品牌id   tb_brand 表里的


 
    private Long cid1;// 1级分类id   ---》tb_category
    private Long cid2;// 2级分类id
    private Long cid3;// 3级分类id    


    private List<Long> price;// 价格   ----》tb_sku
    @Field(type = FieldType.Keyword, index = false)
    private String skus;// sku信息的json结构


    private Map<String, Object> specs;// 可搜索的规格参数，key是参数名，值是参数值   ----tb_spu_details
